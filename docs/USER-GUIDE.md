...
**[Cleaning and rewriting](#cleaning-and-rewriting)** · [Quick text cleanups](#quick-text-cleanups) · [Dates](#dates) · [Numbers](#numbers) · [Phone numbers](#phone-numbers) · [Email to name](#email-to-name) · [Split a column](#split-a-column) · [Split into rows](#split-into-rows) · [Build column from template](#build-column-from-template) · [Calculate](#calculate) · [Find and replace](#find-and-replace)
