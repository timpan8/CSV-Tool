...
export const FLERFIL: Record<string, string> = {
  /* ---------- Jämför två tabeller ---------- */
  'Jämför två tabeller': 'Compare two tables',
  Vänster: 'Left',
  Höger: 'Right',
  'Byt håll: vänster blir höger.': 'Swap sides: left becomes right.',
  'Så jämförs raderna': 'How the rows are compared',
  'Rad mot rad': 'Row by row',
  'Finns någonstans': 'Exists anywhere',
  'Rad 1 mot rad 1, rad 2 mot rad 2 — i den ordning du ser raderna. Sortera båda flikarna på samma sak först, så möts rätt rader.':
    'Row 1 against row 1, row 2 against row 2 — in the order you see the rows. Sort both tabs on the same thing first, and the right rows meet.',
  'Varje värde i vänsterkolumnen letas upp var som helst i högerkolumnen, och tvärtom. Att det finns räcker; antalet visas.':
    'Every value in the left column is looked up anywhere in the right column, and the other way round. Existing is enough; the count is shown.',
  'Kolumner att jämföra': 'Columns to compare',
  'Inga kolumnpar valda. Lägg till minst ett.': 'No column pairs chosen. Add at least one.',
  '＋ Lägg till par': '＋ Add a pair',
  'Så visas svaret': 'How the answer is shown',
  'Färga cellerna': 'Colour the cells',
  'skiljer sig — röd': 'differs — red',
  'saknas — orange': 'missing — orange',
  'lika — grön': 'equal — green',
  'Resultatkolumn per par': 'A result column per pair',
  'I vänsterfliken': 'In the left tab',
  'I båda': 'In both',
  'Två par färgar samma kolumn — det sista paret vinner.': 'Two pairs colour the same column — the last pair wins.',
  jämförs: 'compared',
  Skillnaderna: 'The differences',
  'Bara skillnader': 'Only differences',
  'Välj ett kolumnpar, så visas skillnaderna här.': 'Choose a column pair, and the differences appear here.',
  'Inga skillnader.': 'No differences.',
  Rad: 'Row',
  Utfall: 'Outcome',
  'ingen rad': 'no row',
  'finns inte': 'does not exist',
  'finns {0} gånger': 'exists {0} times',
  'och {0} till': 'and {0} more',
  '{0} lika': '{0} equal',
  '{0} skiljer sig': '{0} differ',
  '{0} saknas': '{0} missing',
  '{0} båda tomma': '{0} both empty',
  '{0} tomma': '{0} empty',
  'Ingenting ändras förrän du trycker Jämför. Svaret skrivs i flikarna du valt, och Ctrl+Z tar tillbaka det där.':
    'Nothing changes until you press Compare. The answer is written into the tabs you chose, and Ctrl+Z takes it back there.',
  Jämför: 'Compare',
  'Välj minst ett kolumnpar och ett sätt att visa svaret.': 'Choose at least one column pair and one way to show the answer.',
  'Jämförelse {0} ↔ {1}': 'Comparison {0} ↔ {1}',
  'Jämförde {0}': 'Compared {0}',
  'Färgade jämförelsen i {0}': 'Coloured the comparison in {0}',
  '{0} lika, {1} skiljer sig, {2} saknas.': '{0} equal, {1} differ, {2} missing.',
  'Inget skrevs — inget att färga eller ingen kolumn vald.': 'Nothing was written — nothing to colour, or no column chosen.',
  'Öppna en fil först': 'Open a file first',
  'Jämförelsen behöver minst en öppen flik — två för att ställa filer mot varandra, eller en för att ställa två kolumner i samma fil mot varandra.':
    'The comparison needs at least one open tab — two to set files against each other, or one to set two columns in the same file against each other.',
