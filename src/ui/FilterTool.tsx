...
export function FilterTool(props: {
  ...
  // Ett filtersvep per öppnad lista, inte ett per tangenttryck i dess sökruta.
  const listrader = useMemo(
    () => (oppenLista === null ? null : utanEgenRegel(frame, filter, oppenLista)),
    [frame, filter, oppenLista],
  )
