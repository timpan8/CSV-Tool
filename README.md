...
- **Matchningsverkstaden** för raderna som blev över. En sammanslagning slutar aldrig på hundra procent, och resten är det arbete verktyg brukar lämna åt användaren. Här blir de omatchade raderna två listor att beta av, med fyra vägar ut: en ny runda på en annan kolumn, ett par gjort för hand, ett värde som rättas på plats så att raden hittar sin partner av sig själv, eller att skriva av raden när ingen partner finns. Sammanslagningen sker först när du är nöjd, och bara en gång.
